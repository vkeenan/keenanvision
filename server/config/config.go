...
func initViper() (Constants, error) {
	...
	if os.Getenv("ENVIRONMENT") == "DOCKER" {
		viper.SetConfigName("keenanvision_docker.config") // Configuration fileName without the .TOML or .YAML extension
	} else {
		viper.SetConfigName("keenanvision.config") // Configuration fileName without the .TOML or .YAML extension
	}
